...
**Original work**: UHHformats by Saskia Otto **Derivative work**:
GHformats by Daniel Hintz **License**: CC BY 4.0 (Creative Commons
Attribution 4.0 International)

------------------------------------------------------------------------

This R package provides ready-to-use R Markdown and **Quarto templates**
for HTML, PDF and Microsoft Word output formats, which are used within
Guardant Health. The package aims to encourage reproducible research
...
- Simple PDF Reports (no toc or company logos)
...
text color. Also the Guardant Health logos on the title page can be
replaced with your own logos.
