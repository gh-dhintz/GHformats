...
format: 
  docx:
    ...
    toc-depth: 3
    toc-title: Contents
    number-sections: false # number sections is configured to true in the template docx file
    reference-doc: "gh-template.docx"
    crossref: 
...
This Quarto template uses a 'gh-template.docx' Word file with Guardant Health branding, with the font type by default set to 'HelveticaNeue'.
