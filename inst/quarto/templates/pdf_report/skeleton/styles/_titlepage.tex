...
\raggedright
% Title and subtitle
{\color{bluegray}\Large\bfseries\nohyphens{$title$}}\\[1.25\baselineskip]
$if(subtitle)${\color{bluegray}\normalsize\textit{$subtitle$}}\\[4\baselineskip]$endif$
...
%%%%%% Guardant Health logo and 2nd logo (='cover' image) at bottom
% \includegraphics[width=6cm]{GH_logo.png}
