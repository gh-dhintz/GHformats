...
% Default spacing for title when no cover image (can be overridden in header-includes)
\newcommand{\nocovertitlespace}{13cm}
...
\fancypagestyle{customtitle}{
	...
	\lfoot{\raisebox{20pt}{\includegraphics{\titlelogoleft}}}
	$else$
	\lfoot{}
	$endif$
	\cfoot{}
	$if(params.title_logo_right)$
	\rfoot{\raisebox{20pt}{\includegraphics{\titlelogoright}}}
	$else$
	\rfoot{}
	$endif$
...
% Configure section marks to show section number and name in header
