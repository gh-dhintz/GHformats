...
params:
  ...
  col_title: "4A5054"  # Guardant Health Data Gray
  col_sections: "000000"
  col_code: "005CB9"  # Guardant Health Science Blue
  col_headerbox: "FBEFCE"
  col_redbox: "EA1D23"  # Guardant Health Blood Red
  col_whitebox: "EDEEEF"  # Guardant Health Light Gray
header-includes: 
  # if you include a logo, don't remove this line!!
  - \newcommand{\logo}{`r gsub("_", "\\_", params$logo)`}
output:
  GHformats::pdf_cheatsheet:
    highlight: "kate"
