...
* `output`: The nested fields for the output field are based on the arguments of the output function. Since `GHformats::pdf_simple` is based on `rmarkdown::pdf_document`, see its help page for more options. Current default settings are
